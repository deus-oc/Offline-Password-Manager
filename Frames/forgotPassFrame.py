...
class ForgotPassFrame(tk.Frame):
	def __init__(self, parent, controller):
		...
		# Send OTP to email to verify email
		...
		# Call chekOTP function and check the OTP
		...
		# Take back to Login Frame if user changed their mind
	...
	# Check the email with database (since changing email is not allowed) and send OTP to the entered email 
	def sendOtp(self):
		...
		mail = SendMail()
		subject = 'Forgot Password - PassMan'
